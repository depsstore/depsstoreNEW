...
const MOCK_PRODUCTS = {
  success: true,
  items: [
    { id: 'mock-1', name: 'Jam Tangan Minimalis', price: 250000, stock: 15, category: 'Aksesoris', image: 'https://via.placeholder.com/300x300' },
    { id: 'mock-2', name: 'Kacamata Retro', price: 180000, stock: 8, category: 'Fashion', image: 'https://via.placeholder.com/300x300' },
    { id: 'mock-3', name: 'Tas Kulit Premium', price: 450000, stock: 5, category: 'Aksesoris', image: 'https://via.placeholder.com/300x300' },
    { id: 'mock-4', name: 'Sepatu Casual', price: 350000, stock: 12, category: 'Fashion', image: 'https://via.placeholder.com/300x300' },
    { id: 'mock-5', name: 'Tumbler Stainless', price: 120000, stock: 20, category: 'Perlengkapan', image: 'https://via.placeholder.com/300x300' },
    { id: 'mock-6', name: 'Dompet Minimalis', price: 95000, stock: 25, category: 'Aksesoris', image: 'https://via.placeholder.com/300x300' }
  ],
  pagination: { total: 6, limit: 8, offset: 0 },
